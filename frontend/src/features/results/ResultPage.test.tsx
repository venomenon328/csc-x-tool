...
describe('own-entry evaluation', () => {
  ...
  it('renders every derived ballot state without official result controls', async () => {
    ...
    expect(screen.queryByText('Keine offizielle Gesamtwertung.')).not.toBeInTheDocument()
    expect(screen.queryByText(/Erhaltene Bewertungen werden ausschließlich/)).not.toBeInTheDocument()
