...
function StandingsContent({ standings }: { standings: ShowStandings }) {
  ...
  return <>
    ...
    {standings.votedCount === 0
      ? <Alert severity="info">Noch keine veröffentlichten Stimmzettel erfasst. Sobald ein Stimmzettel gespeichert ist, erscheint hier der Zwischenstand.</Alert>
...
function StandingsTable({ entries }: { entries: ShowStanding[] }) {
  ...
  return <Paper component="section" sx={{ p: 2 }}>
    <Typography component="h3" sx={{ mb: 2 }} variant="h6">Rangliste</Typography>
