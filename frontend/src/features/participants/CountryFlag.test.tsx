...
describe('CountryFlag', () => {
  it('renders a locally bundled regular flag and a neutral fallback without an image request', () => {
  ...
  it('has a local flag asset for every code in the single backend country catalog', () => {
