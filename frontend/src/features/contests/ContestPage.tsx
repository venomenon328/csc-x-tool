...
export function ContestPage() {
  ...
  return <Stack spacing={3}>
    ...
    {selectedContest !== null && <Box component="section"><Typography component="h2" variant="h6">Eigene Contest-Teilnahme</Typography><Typography color="text.secondary" sx={{ mb: 1 }}>{selectedContest.ownParticipationId === null ? 'Noch nicht festgelegt.' : 'Für diese CSC-Ausgabe festgelegt.'} Die Auswahl erfolgt direkt in der Teilnehmerliste.</Typography><Button component={RouterLink} to="/participants" variant="outlined">Teilnehmer öffnen</Button></Box>}
